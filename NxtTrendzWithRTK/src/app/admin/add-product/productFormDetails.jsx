  ...
  return (
    <div className="p-10">
      <form action={handleFormAction} className="flex flex-wrap gap-10">
        ...
        <input type="text" name="brand" placeholder="brand" className="border" />
        <input type="number" name="price" placeholder="price" className="border" />
        <input type="text" name="rating" placeholder="rating" className="border" />
        <input type="text" name="style" placeholder="style" className="border" />
        <input
          type="number"
          name="totalReviews"
        ...
        <textarea
          ...
          className="border"
        />
        <input type="file" name="imageFile" accept="image/*" className="border" />
